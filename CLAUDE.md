...
This command **requires** the project directory as an argument via `C:\Users\User\Desktop\hire-me-for`.

**Example:** `/create-spec generations/my-app`

**Output location:** `C:\Users\User\Desktop\hire-me-for/prompts/app_spec.txt` and `C:\Users\User\Desktop\hire-me-for/prompts/initializer_prompt.md`

If `C:\Users\User\Desktop\hire-me-for` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `C:\Users\User\Desktop\hire-me-for/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `C:\Users\User\Desktop\hire-me-for/prompts/app_spec.txt`
...
**Output path:** `C:\Users\User\Desktop\hire-me-for/prompts/initializer_prompt.md`
...
**Output path:** `C:\Users\User\Desktop\hire-me-for/prompts/.spec_status.json`
...
> "Your specification files have been created in `C:\Users\User\Desktop\hire-me-for/prompts/`!
>
> **Files created:**
> - `C:\Users\User\Desktop\hire-me-for/prompts/app_spec.txt`
> - `C:\Users\User\Desktop\hire-me-for/prompts/initializer_prompt.md`
>
